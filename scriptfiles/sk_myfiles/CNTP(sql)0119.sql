...
SELECT
 ...
 WHERE
       REPORT_BOARD IN (select report_board from report)
   AND
       REPORT_RESULT IS NULL
 ORDER
    BY
...
SELECT 
       ...
       ,R.REPORT_RESULT
       ,TO_CHAR(R.COMPLETION_DATE, 'YYYY-MM-DD') "COMPLETION_DATE" 
       ,DECODE(#{reportBoard}, 'board', B.MEM_NO, 'board_reply', C.MEM_NO) "MEM_NO"
       ,DECODE(#{reportBoard}, 'board', B.MEM_ID, 'board_reply', C.MEM_ID) "MEM_ID"
       ,DECODE(#{reportBoard}, 'board', B.CONTENT, 'board_reply', C.CONTENT) "CONTENT"
       ,M.MEM_ID "REPORTER_ID" 
  FROM
       REPORT "R"
  JOIN
...
SELECT
       ...
       ,R.REPORT_RESULT
       ,TO_CHAR(R.COMPLETION_DATE, 'YYYY-MM-DD') "COMPLETION_DATE" 
       ,DECODE('board', 'board', M.MEM_NO, 'board_reply', RM.MEM_NO) "MEM_NO"
       ,DECODE('board', 'board', M.MEM_ID, 'board_reply', RM.MEM_ID) "MEM_ID"
       ,DECODE('board', 'board', B.CONTENT, 'board_reply', C.COMMENT_CONTENT) "CONTENT"
       ,M.MEM_ID "REPORTER_ID" 
  FROM
       REPORT "R"
  JOIN
...
SELECT
       ...
       ,R.REPORT_RESULT
       ,TO_CHAR(R.COMPLETION_DATE, 'YYYY-MM-DD') "COMPLETION_DATE" 
       ,DECODE('board_reply', 'board', B.MEM_NO, 'board_reply', C.WRITER) "MEM_NO"
       ,DECODE('board_reply', 'board', M1.MEM_ID, 'board_reply', M2.MEM_ID) "MEM_ID"
       ,DECODE('board_reply', 'board', B.CONTENT, 'board_reply', C.COMMENT_CONTENT) "CONTENT"
