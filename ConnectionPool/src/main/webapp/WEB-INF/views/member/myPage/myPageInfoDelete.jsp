            ...
            <div id="title">회원 탈퇴</div>
                ...
                <div class="del-area">
                    ...
                    <pre class="del-content">
                            [1] 회원 탈퇴 시 삭제된 데이터에 대해 복구가 불가능하며, 개인정보가 필요한 ConnectionPool의 모든 웹서비스 이용이 불가합니다. <br>
                            [2] 을 이용하고 계신 경우, 회원 탈퇴 진행 시 팀도 함께 탈퇴됩니다. <br>
                            [3] 잔여 포인트, 채팅내역, 회원 등급 등의 정보는 모두 삭제되며 복구되지 않습니다. <br>
