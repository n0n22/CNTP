		...
		<div class="find-area">
			...
			<div class="find-id">
				...
				<form action="findId.me" class="find-id-form" method="post">
					...
					<div>
						<div><input type="text" name="memName" required placeholder="이름을 입력해주세요"></div>
					</div>

					<div>
						<div><input type="text" name="phone" required maxlength="13" placeholder="핸드폰번호를 입력해주세요 (- 포함)"></div>
					</div>
